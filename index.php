<?php
    $link = mysqli_connect('localhost:3307','root','','db_companyprofile');
    include "control.php"; 
...
//fungsi fitur kirim email
        ...
        // More headers
        $headers .= 'From: <info@tokoemasduadua.com.com>' . "\r\n";
        $headers .= 'Cc: admin@tokoemasduadua.com' . "\r\n";
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="www.tokoemasduadua.com" class="navbar-brand scroll-top"><?php echo "$showprofile[titlewebsite]"; ?></a>
                </div>
                <!--/.navbar-header-->
                ...
                <div class="col-md-2 col-sm-12">
                    <div class="connect-us">
                        ...
                        <ul>                            
                            ...
                            <li><a href=\"../www.tokopedia.com/$showcontactus[id_twitter]\" target=\"_blank\"><i class=\"fa fa-shopping-bag\"></i></a></li>
                            <li><a href=\"../www.shopee.com/$showcontactus[id_youtube]\" target=\"_blank\"><i class=\"fa fa-shopping-cart\"></i></a></li>
                        </ul>";
                            }
                        ?>
                        <?php 
